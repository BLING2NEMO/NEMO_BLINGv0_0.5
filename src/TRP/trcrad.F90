...
CONTAINS
   ...
   SUBROUTINE trc_rad( kt )
      ...
      IF( lk_bling   ) THEN
        CALL trc_rad_sms( kt, trb, trn, jp_bling0  , jp_bling0+1, cpreserv='Y' )  ! BLINGv0 model PO4 and DOP
        !CALL trc_rad_sms( kt, trb, trn, jp_bling0+2, jp_bling0+2               )  ! BLINGv0 model iron
      ENDIF
